<template>
  <div class="client-section" v-infinite-scroll="fetchData" infinite-scroll-disabled="busy" infinite-scroll-distance="10">
  ...
  export default {
    ...
    methods: {
      async fetchData () {
        ...
        const {data: {code, data}} = await api.get('/Index/Write/UsersList', this.nextPage)
        if (code === 200) {
          this.page ++
